         ...
         <div class="widget-container fluid-height clearfix">
            ...
            <div class="widget-content padded clearfix">
               <div class="widget-content padded">
                  {!! Form::open(array('route' => 'user.save', 'id' => 'user.save', 'onsubmit' => 'return submitVerify()')) !!}
                     <fieldset>
                        <div class="row">
                          <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('username') ? 'has-error' : ''}}">
                              {!! Form::label('username*', '', array('class' => '')) !!}
                                {!! Form::text('username', null, ['class' => 'form-control', 'id' => 'username', 'placeholder' => 'Username', 'autocomplete' => 'off', 'required' => 'true']) !!}
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            <div class="form-group">
                               <label for="name_of_patient">Full Name</label><input class="form-control" id="full_name" name="full_name" type="text">
                            </div>
                          </div>
                        </div>
