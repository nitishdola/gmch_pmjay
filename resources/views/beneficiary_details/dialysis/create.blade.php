   ...
   <div class="col-lg-12">
      <div class="col-lg-12">
         <div class="widget-container fluid-height clearfix">
            <div class="heading">
               <i class="fa fa-table"></i>PMJAY Beneficiaries Dialysis
            </div>
            <div class="widget-content padded clearfix">
               <div class="widget-content padded">
                    {!! Form::open(array('route' => 'beneficary_details.dialysis.save', 'id' => 'beneficary_details.dialysis.save')) !!} 
                     <fieldset>
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              {!! Form::label('Dialysis*', '', array('class' => '')) !!}
                                  {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'required' => true, 'placeholder' => 'Dialysis Name', 'autocomplete' => 'off']) !!}
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                 <label for="test_date">Dialysis Date*</label><input class="form-control zdatepicker" id="date" name="date" required="true" type="text">
                              </div>
                           </div>
                        </div>
                        </div>
