                     ...
                     <fieldset>
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              {!! Form::label('Bed (Ward)*', '', array('class' => '')) !!}
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                 <label for="test_date">Discharged Date*</label><input class="form-control zdatepicker" id="date" name="date" required="true" type="text">
                              </div>
                           </div>
                        </div>
                        </div>
