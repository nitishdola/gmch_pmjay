                     ...
                     <fieldset>
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              {!! Form::label('vendor_name*', '', array('class' => '')) !!}
                                  {!! Form::text('vendor_name', null, ['class' => 'form-control', 'id' => 'vendor_name', 'placeholder' => 'Vendor Name', 'autocomplete' => 'off']) !!}
                           ...
                           <div class="col-md-4">
                              ...
                              {!! Form::label('particulars*', '', array('class' => '')) !!}
                                  {!! Form::text('name', null, ['class' => 'form-control', 'id' => 'name', 'placeholder' => 'Particulars', 'autocomplete' => 'off']) !!}
