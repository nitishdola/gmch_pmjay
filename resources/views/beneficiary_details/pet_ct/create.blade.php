   ...
   <div class="col-lg-12">
      <div class="col-lg-12">
         <div class="widget-container fluid-height clearfix">
            <div class="heading">
               <i class="fa fa-table"></i>PMJAY Beneficiary PET-CT
            </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              ...
                              <div class="form-group">
                                 <label for="test_date">PET_CT Date*</label><input class="form-control zdatepicker" id="date" name="date" required="true" type="text">
                              </div>
                           </div>
                        </div>
                        </div>
